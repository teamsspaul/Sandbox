...
# Data for plotting
FileHandle = "15min_069-179.sorted_Optimize_Gatewidth"
with open(FileHandle+'.txt') as f:
    content = f.readlines()
...
print("The gatewidth whereby the minimum uncertainty exists is: ",GateWidth[MinIndex]*10**6, "us")
